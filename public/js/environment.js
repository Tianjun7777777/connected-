...
function createFonts(scene,data) {
  ...
  loader.load('../assets/fonts/helvetiker_regular.typeface.json', function (font) {
    ...
    scene.add(myFontgeo);
    myFontgeo.position.set(fontdata.positionX+2,fontdata.positionY+2,fontdata.positionZ+2);
    myFontgeo.scale.set(0.02,0.02,0.02);
    // myFontgeo.rotation.x(Math.PI/2);
    // myFontgeo.rotation.y(Math.PI/3);
    // myFontgeo.rotation.z(Math.PI/2);
  });
